export function createSystemPrompt() {
  return [
    ...
    "Use the tools only to read RouterOS reachability, WAN traffic, current failover state, and router log events. Never suggest or attempt router configuration changes.",
