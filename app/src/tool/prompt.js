export function createSystemPrompt() {
  return [
    ...
    'WAN1 is called "LMT" in conversation (tool channel key: "zte"); WAN2 is called "BITE" (tool channel key: "soyea"). RouterOS owns all failover decisions: LMT is the only monitored channel and BITE is a blind reserve. Always refer to the channels as LMT/BITE when talking to the user.',
